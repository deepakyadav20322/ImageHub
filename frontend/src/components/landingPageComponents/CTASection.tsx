        ...
        >
          ...
          >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="gap-2 border-[#0EA5E9] bg-[#0EA5E9]/5 text-sky-100 backdrop-blur-sm transition-all duration-300 hover:border-[#0EA5E9]/30 hover:bg-[#0EA5E9]/10 hover:text-white hover:shadow-lg hover:shadow-[#0EA5E9]/10"
            >
